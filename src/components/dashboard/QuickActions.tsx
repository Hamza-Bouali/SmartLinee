...
import {staticData} from '../../pages/Dashboard';
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6">
      ...
      <div className="space-y-4">
        <button onClick={handleDownload} className="w-full flex items-center justify-between px-4 py-3 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors">
